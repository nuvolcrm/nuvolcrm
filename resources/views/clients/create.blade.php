                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div>
                            ...
                            <input type="text" name="dni" placeholder="Nº de DNI, NIE, PAS ó CIF"
                                class="form-control mb-2" value="{{ old('dni') }}" required>
                            @error('dni')
                    ...
                    <div class="col-md-3">
                        <div>
                            ...
                            <input type="file" name="subirdni" placeholder="Selecciona archivo"
                                value="{{ old('subirdni') }}" required>
                            @error('subirdni')
                                <small class="text-danger">*{{ $message }}</small>
                            @enderror
                        </div>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div>
                            ...
                            <input type="text" name="alias" placeholder="Ej: TOMASI" class="form-control mb-2"
                                value="{{ old('alias') }}">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div>
                            ...
                            <input type="text" name="nombre" placeholder="Ej: TOMASA" class="form-control mb-2"
                    ...
                    <div class="col-md-3">
                        <div>
                            ...
                            <input type="text" name="apellido1" placeholder="Ej: GARCIA" class="form-control mb-2"
                    ...
                    <div class="col-md-3">
                        <div>
                            ...
                            <input type="text" name="apellido2" placeholder="Ej: LOPEZ"
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div>
                            ...
                            <input type="iban" name="cuenta" required placeholder="Ej: ES1020386090432000225568"
                                class="form-control mb-2" value="{{ old('cuenta') }}">
                            @error('iban')
                                <small class="text-danger">*{{ $message }}</small>
                            @enderror
                        </div>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div>
                            ...
                            <input type="tel" name="telefono" required placeholder="Ej: 644744866" maxlength="9"
                    ...
                    <div class="col-md-3">
                        <div>
                            ...
                            <input type="tel" name="telefono" required placeholder="Ej: 619636122" maxlength="9"
                                pattern="[6-7-9]{1}[0-9]{8}" value="{{ old('telefono') }}" class="form-control mb-2">
                            @error('telefono')
                                <small class="text-danger">*{{ $message }}</small>
                            @enderror
                    ...
                    <div class="col-md-3">
                        <div>
                            ...
                            <input type="email" name="email" required placeholder="Ej: HOLA@MOVY.ES"
                                class="form-control mb-2" value="{{ old('email') }}">
                            @error('email')
                                <small class="text-danger">*{{ $message }}</small>
                            @enderror
                        </div>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div>
                            ...
                            <input type="text" name="direccion" placeholder="Ej: CALLE CONVENT, 89 PISO 3 PUERTA 8"
                                class="form-control mb-2" value="{{ old('direccion') }}" required>
                            @error('direccion')
                                <small class="text-danger">*{{ $message }}</small>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-3">
                        <div>
                            ...
                            <input type="text" class="form-control mb-2" name="codigoPostal" data-rule-number="true"
                                maxlength="5" placeholder="Ej: 46200" value="{{ old('codigoPostal') }}" required>
                            @error('codigoPostal')
                                <small class="text-danger">*{{ $message }}</small>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-3">
                        <div>
                            ...
                            <input type="text" name="poblacion" placeholder="Ej: PAIPORTA" class="form-control mb-2"
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="input-group mb-3">
                            <input type="text" name="provincia" class="form-control" placeholder="Ej: VALENCIA">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div>
                            ...
                            <input type="text" name="keywords" placeholder="Ej: JUANJO, NEOKIDS, LAPICES"
                                class="form-control mb-2" value="{{ old('keywords') }}">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div>
                            <label class="control-label">Observaciones</label>
                            <input type="text" name="observaciones" placeholder="Ej: AMIGO DE JUANJO"
                    ...
                    <div class="col-md-3">
                        <div>
                            ...
                            <input type="text" name="comercial" placeholder="Ej: JAVIER PEREZ" class="form-control mb-2"
                                value="{{ old('comercial') }}">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div>
                            ...
                            <input type="text" name="compania" placeholder="Ej: FB16FEB21, flyers..."
                                class="form-control mb-2" value="{{ old('compania') }}">
                        </div>
                    </div>
                </div>
                <div>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div>
                            ...
                            <input type="text" name="otros" placeholder="Ej: MOVY.ES" class="form-control mb-2"
                                value="{{ old('otros') }}">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div>
                            ...
                            <input type="text" name="otros" placeholder="Ej: MOVY SERVICIOS INTEGRALES SL"
                                class="form-control mb-2" value="{{ old('otros') }}">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div>
                            ...
                            <input type="text" name="otros"
                                placeholder="Ej: Dirección fiscal es CALLE CONVENT 89 PAIPORTA"
                                class="form-control mb-2" value="{{ old('otros') }}">
                        </div>
                    </div>
                </div>
