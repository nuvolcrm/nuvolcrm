    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm">
                <h1>
                    Presupuestos
                    <a href="{{ route('presupuestos.create') }}" class="rounded-circle btn btn-primary">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($pre->alias != '')
                                            ("{{ $pre->alias }}")
                                        @endif
                                        {{ $pre->nombre . ' ' . $pre->apellido1 . ' ' . $pre->apellido2 }}
                                    </td>
                                    ...
                                    <td>
                                        @if ($pre->fibra)
                                            <i class="fas fa-wifi"></i> {{ $pre->fibra }}
                                        @endif
                                        @if ($pre->movil)
                                            <i class="fas fa-mobile-alt"></i> {{ $pre->movil }}
                                        @endif
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <a href='presupuestos/{{ $pre->idPresupuesto }}'><i
                                                class='far fa-list-alt text-primary'></i></a>

                                        <!-- </button> -->
                                    </td>
                                    <td>
                                        <button-sm class='btn-sm alert-light'>
                                            <a target='_blank' href="{{-- {{ route('imprimir') }} --}}"><i
