...
@section('title', 'Pedido: ' . $pedido->nombre)
...
<h4>Aquí pondremos todos los campos de la ficha del Cliente. Desde los botones
    de arriba, podremos volver al listado o editarlo. esta vista nos servirá
    para enlazarla desde presupuesto o ventas para ver a ficha. Contenido por
    definir.</h4>
@stop
